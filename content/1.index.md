...
A lightweight Nuxt template to build a Markdown driven website, based on [Nuxt Content](https://content.nuxtjs.org), [WindiCSS](https://windicss.org/) and [Iconify](https://iconify.design) :sparkles:
...
Or start by clicking on **Use this template** on [github.com/roiLeo/nuxt3-content](https://github.com/roiLeo/nuxt3-content).
...
The navigation is generated from your pages, you can take a look at the [`<MainNavbar>`](https://github.com/roiLeo/nuxt3-content/blob/main/components/MainNavbar.vue) component to see how it works.
...
See the `<Alert>` component in [`components/content/Alert.vue`](https://github.com/roiLeo/nuxt3-content/blob/main/components/content/Alert.vue).
...
If you want to go deeper, take a look at the [`<List>`](https://github.com/roiLeo/nuxt3-content/blob/main/components/content/List.vue) component to see some `useUnwrap()` magic :magic_wand:
...
You are at the end of the page, you can checkout the [about page](/about) or the [GitHub repository](https://github.com/roiLeo/nuxt3-content) and give a :icon{name="ph:star-duotone"}

Thanks to [Atinux](https://twitter.com/Atinux) for this wonderful project 💚.
